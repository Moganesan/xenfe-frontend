...
@Component({
  selector: 'app-order-to-pack-view',
  templateUrl: './order-to-pack-view.component.html',
  styleUrls: ['./order-to-pack-view.component.scss']
})
export class OrderToPackViewComponent implements OnInit {
