        ...
        this.quoteService.GetSingleProductorder(this.id).subscribe(qtn => {
          ...
          setTimeout(() => {
            ...
            //for (i = 0; i < arraylength; ++i) {
              ...
              this.quoteTempData.data[index].lineDiscountPriceExclTax = this.quotationDetail[index].line_discount_price_wo_tax
 ...
 //       this.cdr.detectChanges();
    ...
    UpdateQDLine(i) {
      ...
      let ToUpdate = {
        ...
        igst: this.quoteTempData.data[i].igst, 
        cgst: this.quoteTempData.data[i].cgst,
        sgst: this.quoteTempData.data[i].sgst,
        line_total: this.quoteTempData.data[i].linetotal,
        lineDiscountPriceExclTax: this.quoteTempData.data[i].lineDiscountPriceExclTax,
        lineDiscountPrice: this.quoteTempData.data[i].lineDiscountPrice
      ...
      this.httpClient.post(`${this.serverURL}/quote/updateProductInOrderDetailTable/`, ToUpdate).subscribe((data: any) => {
        //console.log(Response)
      })
